...
public class Sorts {
    ...
    /**
     * Begins the process to sort the array according to the merge sort algorithm.
     *
     * @param <T> the carrier type of the array
     * @param arr the array to sort
     * @return the sort events generated by this sort
    ...
    /**
     * Splits the array according to the merge sort algorithm.
     *
     * @param <T> the carrier type of the array
     * @param arr the array to sort
     * @param lo the lowest index of the array
     * @param hi the highest index of the array
     * @param lst the list of sortEvents
     */
    ...
    /**
     * Begins sorting the array according to the quick sort algorithm.
     *
     * @param <T> the carrier type of the array
     * @param arr the array to sort
     * @return the sort events generated by this sort
    ...
    /**
     * Sorts the array according to the combSort algorithm
     *
     * @param <T> the carrier type of the array
     * @param arr the array to sort
     * @return the sort events generated by this sort
    ...
    /**
     * Applies a list of sorting events to an array
     *
     * @param <T> the carrier type of the array
